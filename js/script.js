...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 28.543169, lng: 77.14811, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 28.543169, lng: 77.14811, title: 'IBM Research, India',
      infoWindow: { content: '<p>IBM Research India, ISID Campus C4, Vasant Kunj Institutional Area, Vasant Kunj New Delhi, DL 110070, India</p>' } });
